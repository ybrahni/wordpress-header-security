...
Upload the wordpress-header-security folder to the /wp-content/plugins/ directory.
Activate the plugin through the 'Plugins' menu in WordPress.
Go to the plugin's settings page by clicking on 'WP Header Security' under the 'Settings' menu in the WordPress admin panel.
Choose the recommended or custom options for each security header.
...
This plugin requires WordPress version 5.8 or higher and has been tested up to version 6.2.
